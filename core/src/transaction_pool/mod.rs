...
pub struct TransactionPool {
    ...
    //origin transaction generated by the local conflux node/wallet
    origin_to_propagate_trans: Arc<RwLock<HashMap<H256, Arc<SignedTransaction>>>>,
...
impl MallocSizeOf for TransactionPool {
    fn size_of(&self, ops: &mut MallocSizeOfOps) -> usize {
        ...
        let origin_to_propagate_trans_size =
            self.origin_to_propagate_trans.read().size_of(ops);
        ...
        self.config.size_of(ops)
            ...
            + origin_to_propagate_trans_size
...
impl TransactionPool {
    ...
    ) -> Self
    {
        ...
        TransactionPool {
            ...
            origin_to_propagate_trans: Arc::new(RwLock::new(HashMap::new())),
    ...
    pub fn get_origin_to_be_propagated_transactions(
        &self,
    ) -> HashMap<H256, Arc<SignedTransaction>> {
        let mut to_prop = self.origin_to_propagate_trans.write();
        let mut res = HashMap::new();
        mem::swap(&mut *to_prop, &mut res);
        res
    }
    ...
    pub fn set_origin_to_be_propagated_transactions(
        &self, transactions: HashMap<H256, Arc<SignedTransaction>>,
    ) {
        let mut to_prop = self.origin_to_propagate_trans.write();
        to_prop.extend(transactions);
    ...
    pub fn remove_origin_to_be_propagated_transactions(&self, tx_hash: &H256) {
        self.origin_to_propagate_trans.write().remove(tx_hash);
    }
